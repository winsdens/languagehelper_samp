...
function main()
	...
	-- логи о запуске
	sampAddChatMessage(u8:decode("{5A90CE}" .. tag .. " - LangHelper {d5dedd}успешно загружен. | {5A90CE}Версия: {d5dedd}1.0 | {5A90CE}Автор: {d5dedd}sunbakes (Hannah Murphy)"), main_color)
